...
#
# The pattern achieves it by sharing parts of object state between multiple objects. In other words, the Flyweight
# saves RAM by caching the same data used by different objects.
#
# Complexity: xxx
# Popularity:
#
